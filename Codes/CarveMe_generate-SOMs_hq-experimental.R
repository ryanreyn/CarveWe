...
mean_df$row_names<-c(1,2,1,2,3,1,2,3)
mean_df$column_names<-c(1,1,2,2,2,3,3,3)
...
plot_df$row_names <- c(1,2,1,2,3,1,2,3)
plot_df$column_names <- c(1,1,2,2,2,3,3,3)
...
phylo_df$row_names<-c(1,2,1,2,3,1,2,3)
phylo_df$column_names<-c(1,1,2,2,2,3,3,3)
...
#Now plot
ggplot(pivot_df, aes(y = as.factor(cluster), x = diff, fill = as.factor(cluster))) +
